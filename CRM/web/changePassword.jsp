    ...
    <a href="${dashboardUrl}" class="btn-dashboard">
                    ...
                    <div id="newPasswordSection" class="form-section">
                        <div class="form-group">
                            ...
                            <div class="password-requirements" id="requirements">
                                ...
                                <div class="requirement" id="req-no-space">
                                    <i class="fas fa-circle"></i>
                                    <span>No spaces allowed</span>
                                </div>
                                <div class="requirement" id="req-char">
                                    <i class="fas fa-circle"></i>
                                    <span>Must include letters and numbers</span>
                                </div>
                            </div>
                        </div>
        ...
        <script>
            ...
            function checkPasswordStrength() {
                ...
                const hasSpace = !/\s/.test(password); // ❌ Không cho phép khoảng trắng
                const hasChar = /[A-Za-z]/.test(password) || /[0-9]/.test(password); // ✅ Phải có ít nhất 1 chữ cái và 1 số

                updateRequirement('req-length', hasLength);
     
                updateRequirement('req-no-space', hasSpace); // ❌ Không có dấu cách
updateRequirement('req-char', hasChar);
            ...
            function validatePassword(password) {
                ...
                return hasLength && hasChar && hasSpace  ;
            }
