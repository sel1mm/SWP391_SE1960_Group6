...
<html lang="vi">
    ...
    <body>
        ...
        <div id="payment-data" 
             data-payment-amount="${repairReport != null && repairReport.estimatedCost != null ? repairReport.estimatedCost * 26000 : 0}"
                        ...
                        <div class="info-card">
                            ...
                            <div class="info-item">
                                ...
                                <span class="info-value">
                                    <fmt:formatNumber value="${repairReport.estimatedCost * 26000}" type="number" maxFractionDigits="0" /> ₫
                                </span>
                            </div>
                            <div class="info-item">
