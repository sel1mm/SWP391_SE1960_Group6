...
public class PaymentServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // ✅ Lấy RepairReport theo reportId (nếu có)
            ...
            // ✅ Tạo Payment.pending khi mở trang (nếu chưa có)
            if (repairReport != null) {
                ...
                if (existingPaymentId == null) {
                    ...
                    if (invoiceId > 0) {
                        // ❌ XÓA createInvoiceDetail Ở ĐÂY - Không tạo trong doGet()
                        ...
                        System.out.println("✅ Created Pending Payment (NO InvoiceDetail):");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String requestIdStr = request.getParameter("requestId");
        String reportIdStr = request.getParameter("reportId"); // ✅ LẤY reportId
        String paymentMethod = request.getParameter("paymentMethod");

        System.out.println("=== PAYMENT SERVLET POST ===");
        System.out.println("RequestId: " + requestIdStr);
        System.out.println("ReportId: " + reportIdStr); // ✅ LOG reportId
        ...
        try {
            ...
            // ✅ Lấy RepairReport ĐÚNG
            RepairReport report = null;

            // Ưu tiên lấy từ reportId parameter
            if (reportIdStr != null && !reportIdStr.trim().isEmpty()) {
                try {
                    int reportId = Integer.parseInt(reportIdStr.trim());
                    report = serviceRequestDAO.getRepairReportById(reportId);
                    System.out.println("✅ Using reportId from parameter: " + reportId);

                    if (report != null) {
                        System.out.println("   - TechnicianName: " + report.getTechnicianName());
                        System.out.println("   - EstimatedCost: " + report.getEstimatedCost());
                    }
                } catch (NumberFormatException e) {
                    System.err.println("❌ Invalid reportId format: " + reportIdStr);
                }
            ...
            if (report == null) {
                ...
                System.out.println("⚠️ Using any report from requestId: " + requestId);
            }
            ...
            System.out.println("Final amount: " + paymentAmount);
            if (report != null) {
                System.out.println("From report: " + report.getReportId());
                System.out.println("Technician: " + report.getTechnicianName());
            }
